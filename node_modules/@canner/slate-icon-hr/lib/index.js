...
exports.default = exports.HrPlugin = void 0;
...
var HrPlugin = function HrPlugin(opt) {
  var options = Object.assign({
    hrType: _blocks.HR
  }, opt);
  return {
    renderNode: function renderNode(props) {
      if (props.node.type === options.hrType) return React.createElement("hr", null);
    }
  };
};
...
function (_React$Component) {
  _inherits(HRIcon, _React$Component);

  function HRIcon(props) {
    var _this;

    _classCallCheck(this, HRIcon);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(HRIcon).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function (e) {
      ...
      e.preventDefault();
      onChange(change.insertBlock({
        type: _this.typeName,
        isVoid: true
      }).collapseToStartOfNextBlock().focus());
    });

    _this.typeName = _this.props.type || _blocks.HR;
    return _this;
  }
