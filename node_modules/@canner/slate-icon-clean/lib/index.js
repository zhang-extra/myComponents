...
exports.default = exports.CleanPlugin = void 0;

var React = _interopRequireWildcard(require("react"));

var _slateHelperMarkRemoveall = _interopRequireDefault(require("@canner/slate-helper-mark-removeall"));
...
var CleanPlugin = function CleanPlugin() {
  return {
    onKeyDown: function onKeyDown(event, change) {
      if ((0, _isHotkey.default)("ctrl+opt+n", event)) {
        return (0, _slateHelperMarkRemoveall.default)(change);
      }
    }
  };
};
...
function (_React$Component) {
  ...
  function Clean(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Clean).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function (e) {
      ...
      e.preventDefault();
      onChange((0, _slateHelperMarkRemoveall.default)(change));
    });
