...
&nbsp;
export const BoldPlugin = <span class="fstat-no" title="function not covered" >(o</span>pt) =&gt; {
  const options = <span class="cstat-no" title="statement not covered" >Object.assign({</span>
    type: BOLD,
    tagName: 'strong'
  }, opt);
&nbsp;
<span class="cstat-no" title="statement not covered" >  return markPlugin(options, 'cmd+b')</span>
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Sep 04 2018 17:55:20 GMT+0800 (CST)
</div>
</div>
