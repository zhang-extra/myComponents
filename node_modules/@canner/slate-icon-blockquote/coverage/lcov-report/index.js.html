...
&nbsp;
export const BlockquotePlugin = <span class="fstat-no" title="function not covered" >(o</span>pt) =&gt; {
...
<span class="cstat-no" title="statement not covered" >        return commonNode(options.tagName, omit(options, ['type', 'tagName']))(props);</span>
    },
    onKeyDown(event, change) {
<span class="cstat-no" title="statement not covered" >      if (isHotkey('ctrl+opt+q', event)) {</span>
<span class="cstat-no" title="statement not covered" >        return blockquote(change, {type: options.type})</span>
      }
    }
  }
}
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Sep 04 2018 17:51:10 GMT+0800 (CST)
</div>
</div>
