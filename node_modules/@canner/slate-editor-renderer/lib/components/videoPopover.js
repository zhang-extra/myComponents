...
var _jsVideoUrlParser = _interopRequireDefault(require("js-video-url-parser"));
...
var _default = (_dec = _antd.Form.create(), _dec(_class =
/*#__PURE__*/
function (_React$Component) {
  ...
  function VideoModal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleOk", function (e) {
      ...
      var _this$props = _this.props,
          ...
          hidePopover = _this$props.hidePopover,
      ...
      form.validateFields(function (err, values) {
        if (!err) {
          ...
          if (href) {
            var videoObj = _jsVideoUrlParser.default.parse(href);
  ...
  _createClass(VideoModal, [{
    ...
    value: function checkSource(rule, value, callback) {
      try {
        var videoObj = _jsVideoUrlParser.default.parse(value);
