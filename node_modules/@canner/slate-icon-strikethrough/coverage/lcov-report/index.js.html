...
&nbsp;
export const StrikeThroughPlugin = <span class="fstat-no" title="function not covered" >(o</span>pt) =&gt; {
  const options = <span class="cstat-no" title="statement not covered" >Object.assign({</span>
    type: STRIKETHROUGH,
    tagName: 's'
  }, opt);
&nbsp;
<span class="cstat-no" title="statement not covered" >  return markPlugin(options, 'ctrl+opt+d')</span>
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Sep 04 2018 18:50:55 GMT+0800 (CST)
</div>
</div>
