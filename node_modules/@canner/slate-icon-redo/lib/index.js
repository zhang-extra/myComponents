...
exports.default = exports.RedoPlugin = void 0;
...
var RedoPlugin = function RedoPlugin() {
  return {
    onKeyDown: function onKeyDown(event, change) {
      if ((0, _isHotkey.default)("cmd+shift+y", event)) {
...
function (_React$Component) {
  ...
  function Redo(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Redo).call(this, props));
