...
<html lang="en">
<head>
    <title>Code coverage report for pluginListDecorator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> pluginListDecorator.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    render() {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (defaultIcon === 'ListBullet') {
        // ul list
        typeOpts = {
