  ...
  return function (Block) {
    return (
      ...
      function (_React$Component) {
        _inherits(IndentDecorator, _React$Component);

        function IndentDecorator(props) {
          var _this;

          _classCallCheck(this, IndentDecorator);

          _this = _possibleConstructorReturn(this, _getPrototypeOf(IndentDecorator).call(this, props));
          ...
          _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function (e) {
            ...
            if (value.blocks) {
              value.blocks.forEach(function (block) {
                var getBlockIndent = block.get("data") && block.get("data").get("indent") || 0;
                var indent = getBlockIndent;
                ...
                var newData = block.setIn(["data", "indent"], indent);
